...
class SingleSimpleProductTest extends PlaceOrderAbstract
{
    ...
    public function testGetBasketCall()
    {
        ...
        $order        = $this->getOrder();
        $this->assertEquals(self::CREATED_AT_TIMESTAMP_EXPECTED_UTC, $order->getCreatedAt());
        // PST 'March 23, 2018 at 11:29:00 AM' is UTC '2018-03-23T18:29:00.232648Z'
        $this->assertEquals(self::CREATED_AT_TIMESTAMP_EXPECTED_PST, $order->getCreatedAtFormatted(\IntlDateFormatter::LONG));
        $order = $this->getOrder();
