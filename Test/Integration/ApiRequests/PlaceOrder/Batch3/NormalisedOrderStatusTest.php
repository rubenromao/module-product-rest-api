...
class NormalisedOrderStatusTest extends PlaceOrderAbstract
{
    /**
     * @magentoApiDataFixture apiFixtures
     * @magentoApiDataFixture loadCountryDefaults
     * @magentoApiDataFixture addNewDefaultNewStatus
     */
    public function testNormalisedOrderStatus()
    {
        ...
        $searchCriteria = $searchCriteriaBuilder->addFilter('rezolve_order_id', $orderId)->create();
        ...
        foreach ($orders as $order) {
            $this->assertEquals('custom_status_in_new_state', $order->getStatus());
        }
    }
