...
class MustAddRequiredOptionsTest extends PlaceOrderAbstract
{
    /**
    ...
    public function testGetBasketCall()
    {
        ...
        $expectedJson = $this->getErrorJson($optionId);
...
JSON;
    ...
    private function getErrorJson($optionId)
    {
        return <<<JSON
{
