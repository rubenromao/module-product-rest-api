...
class PhoneNumberIsSavedTest extends PlaceOrderAbstract
{
    /**
    ...
    public function testGetBasketCall()
    {
        ...
        $expectedPhoneNumber = '07999123123';
        $this->assertEquals($expectedPhoneNumber, $billingAddress->getTelephone(), 'Billing phone number is wrong');
        $this->assertEquals($expectedPhoneNumber, $shippingAddress->getTelephone(), 'Shipping phone number is wrong');
    }
...
JSON;
    ...
    public function getExpectedJson($orderId, $status = 'processing')
    {
