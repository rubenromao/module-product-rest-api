...
use Rezolve\APISalesV4\Model\Basket\PartnerId;
use Rezolve\APISalesV4\Test\Integration\ApiRequests\PlaceOrder\PlaceOrderAbstract;

class PartnerIdIsSavedTest extends PlaceOrderAbstract
{
    /**
    ...
    public function testGetBasketCall()
    {
        ...
        $expectedPartnerId = 10;
        $this->assertEquals($expectedPartnerId, $order->getData(PartnerId::REZOLVE_PARTNER_ID));
    }
