...
class RezolveCustomerIdIsSetTest extends PlaceOrderAbstract
{
    const REZOLVE_CUSTOMER_ID = '123456789-A';
    /**
    ...
    public function testGetBasketCall()
    {
        ...
        $expectedRezolveCustomerId = self::REZOLVE_CUSTOMER_ID;
        $requestJson  = $this->getRequestJson($orderId, $expectedRezolveCustomerId);
        ...
        $this->assertEquals($expectedRezolveCustomerId, $order->getData('rezolve_customer_id'));
    }

    private function getRequestJson($orderId, $expectedRezolveCustomerId)
    {
            ...
            <<<JSON
{
    ...
    "customer_details": {
        ...
        "customer_identifier": "$expectedRezolveCustomerId",
        "first_name": "John",
        "last_name": "Smith",
        "has_loyalty_card": 1,
