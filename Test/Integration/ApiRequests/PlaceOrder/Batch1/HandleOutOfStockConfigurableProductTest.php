...
class HandleOutOfStockConfigurableProductTest extends PlaceOrderAbstract
{
    ...
    public function testOutOfStockWorks()
    {
        ...
        $requestJson  = $this->getRequestJson($orderId, $colourId, $sizeId);
    ...
    private function getRequestJson($orderId, $colourId, $sizeId)
    {
