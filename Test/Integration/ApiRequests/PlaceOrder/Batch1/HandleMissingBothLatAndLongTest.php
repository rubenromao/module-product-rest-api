...
use Rezolve\APISalesV4\Model\Basket\Location;
use Rezolve\APISalesV4\Test\Integration\ApiRequests\PlaceOrder\PlaceOrderAbstract;

class HandleMissingBothLatAndLongTest extends PlaceOrderAbstract
{
    /**
    ...
    public function testGetBasketCall()
    {
        ...
        $lat  = $order->getData(Location::REZOLVE_LAT_CODE);
        $long = $order->getData(Location::REZOLVE_LONG_CODE);
        $this->assertEquals(null, $lat);
        $this->assertEquals(null, $long);
    }
